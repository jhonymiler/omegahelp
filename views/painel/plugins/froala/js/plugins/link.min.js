...
! function ( e, t ) {
    ...
    y = y && y.hasOwnProperty( "default" ) ? y[ "default" ] : y, Object.assign( y.POPUP_TEMPLATES, {
        ...
        function v() {
            ...
            var n = h.selection.element(),
                i = h.selection.endElement();
            "A" == n.tagName || h.node.isElement( n ) || ( n = m( n ).parentsUntil( h.$el, "a" ).first().get( 0 ) ), "A" == i.tagName || h.node.isElement( i ) || ( i = m( i ).parentsUntil( h.$el, "a" ).first().get( 0 ) );
            try {
        ...
        function b() {
            var e, t, n, i, r = h.image ? h.image.get() : null,
                a = [];
            if ( r ) "A" == r.get( 0 ).parentNode.tagName && a.push( r.get( 0 ).parentNode );
                ...
                if ( l.getRangeAt && l.rangeCount ) {
                    ...
                    for ( var s = 0; s < l.rangeCount; ++s )
                        if ( ( t = ( e = l.getRangeAt( s ) ).commonAncestorContainer ) && 1 != t.nodeType && ( t = t.parentNode ), t && "a" == t.nodeName.toLowerCase() ) a.push( t );
                        else {
                ...
                if ( "a" == ( t = ( e = h.doc.selection.createRange() ).parentElement() ).nodeName.toLowerCase() ) a.push( t );
                else {
                        ...
                        if ( e && !t ) {
                            if ( h.image ) {
                                ...
                                if ( 1 == n.length && "IMG" == n[ 0 ].tagName ) {
                                    ...
                                    return 0 === i.startOffset && 0 === i.endOffset ? m( e ).before( y.MARKERS ) : m( e ).after( y.MARKERS ), h.selection.restore(), !1
                                }
                            }
        ...
        function p( e, t, n ) {
            ...
            if ( "" === h.opts.linkAutoPrefix || new RegExp( "^(" + y.LinkProtocols.join( "|" ) + "):.", "i" ).test( e ) || /^data:image.*/i.test( e ) || /^(https?:|ftps?:|file:|)\/\//i.test( e ) || /^([A-Za-z]:(\\){1,2}|[A-Za-z]:((\\){1,2}[^\\]+)+)(\\)?$/i.test( e ) || [ "/", "{", "[", "#", "(", ".", "$" ].indexOf( ( e || "" )[ 0 ] ) < 0 && ( e = h.opts.linkAutoPrefix + e ), h.opts.linkAlwaysBlank && ( n.target = "_blank" ), h.opts.linkAlwaysNoFollow && ( n.rel = "nofollow" ), h.helpers.isEmail( r ) && ( n.target = null, n.rel = null ), "_blank" == n.target ? ( h.opts.linkNoOpener && ( n.rel ? n.rel += " noopener" : n.rel = "noopener" ), h.opts.linkNoReferrer && ( n.rel ? n.rel += " noreferrer" : n.rel = "noreferrer" ) ) : null == n.target && ( n.rel ? n.rel = n.rel.replace( /noopener/, "" ).replace( /noreferrer/, "" ) : n.rel = null ), t = t || "", e === h.opts.linkAutoPrefix ) return h.popups.get( "link.insert" ).find( 'input[name="href"]' ).addClass( "fr-error" ), h.events.trigger( "link.bad", [ r ] ), !1;
            var a, l = v();
            if ( l ) {
        ...
        function f() {
            ...
            if ( e ) {
                var t = h.popups.get( "link.insert" );
                h.image.hasCaption() && ( e = e.find( ".fr-img-wrap" ) ), t || ( t = s() ), o(), h.popups.setContainer( "link.insert", h.$sc );
                var n = e.offset().left + e.outerWidth() / 2,
                    i = e.offset().top + e.outerHeight();
                h.popups.show( "link.insert", n, i, e.outerHeight(), !0 )
            }
        }
        return {
            _init: function e() {
            ...
            insertCallback: function k() {
                var e, t, n = h.popups.get( "link.insert" ),
