...
function content_613d762d4f18e0_83509770 (Smarty_Internal_Template $_smarty_tpl) {
?><!-- Media table sample -->
<!-- DataTables  & Plugins -->
<div class="row">
    <div class="col-md-6">
...
dist/img/atendente.png"
                                            ...
                                            <?php } elseif ($_smarty_tpl->tpl_vars['user_data']->value['USU_nivel'] == 3) {?>
                                                <img width="65" src="<?php echo $_smarty_tpl->tpl_vars['_pgParams']->value['path_layout'];?>
dist/img/atendente.png"
                                                    class="atendente" alt="Atendente">
                                            <?php }?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                        ...
                        <?php if (is_array($_smarty_tpl->tpl_vars['user']->value) && $_smarty_tpl->tpl_vars['user']->value['USU_nivel'] > 1) {?>
...
$_smarty_tpl->tpl_vars['departamento']->do_else = true;
if ($_from !== null) foreach ($_from as $_smarty_tpl->tpl_vars['departamento']->value) {
$_smarty_tpl->tpl_vars['departamento']->do_else = false;
?>
                                    <option value="<?php echo $_smarty_tpl->tpl_vars['departamento']->value['DEP_id'];?>
"><?php echo $_smarty_tpl->tpl_vars['departamento']->value['DEP_titulo'];?>
</option>
                                <?php
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
...
painel/usuarios/excluir';
    ...
    function enviar() {
        ...
        if ($("#USU_nivel").val() < 1 && $("#DEP_id").val() > 0) {
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo $_smarty_tpl->tpl_vars['FormAction']->value;?>
',
